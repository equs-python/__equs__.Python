...
| 9.00 - 10.30 | **Welcome remarks** <br> Getting started with Python <br> *Virginia Frey*| Packaging Python code and documentation <br> *Yuval Sanders* | Interfacing with experiment hardware <br> *Lachlan Rogers* | Introduction to [pyGSTi](http://www.pygsti.info/) <br> *Kenny Rudinger & Erik Nielsen*|
...
| 14.00 - 14.30 | Advanced Python programming <br> *Alan Robertson* | Version control with git and GitHub <br> *Alan Robertson* | TBA | Break <br> *& debugging* |
| 14.30 - 15.30 | Advanced Python programming <br> *Alan Robertson* | Surprise coding project | TBA | Introduction to [qinfer](http://qinfer.org) <br> *Chris Ferrie* |
| 15.30 - 16.00 |  Afternoon tea <br> *& debugging* | Afternoon tea <br> *& debugging* |  | Afternoon tea <br> *& debugging* | 
| 16.00 - 17.00 | Python for scientific computing <br> *Virginia Frey* | Surprise coding project | | Introduction to [OpenFermion](https://github.com/quantumlib/OpenFermion) <br> *Ryan Babbush*|
